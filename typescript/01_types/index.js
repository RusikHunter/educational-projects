...
var PersonWrap = /** @class */ (function () {
    function PersonWrap(name, age, isActive) {
        this.name = name;
        this.age = age;
        this.isActive = isActive;
    }
    PersonWrap.prototype.greet = function () {
        console.log("Hello! My name is ".concat(this.name, ". I am ").concat(this.age, " y.o."), this.isActive);
    };
    return PersonWrap;
}());
var abdullah = new PersonWrap("Abdullah", 19, true);
abdullah.greet();
