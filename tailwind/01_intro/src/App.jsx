    ...
    return (
        <>
            ...
            <main>
                ...
                <button className="flex justify-center items-center mt-50 mx-auto w-100 h-30 bg-gray-400 rounded-4xl hover:bg-gray-700 transition-colors duration-300 ease-in-out cursor-pointer animate-bounce shadow-xl shadow-green-100">Add Image</button>
            </main>
